...
import { faSearch, faCartShopping, faClose, faUser } from '@fortawesome/free-solid-svg-icons'
        ...
        <div>
            <nav className={`navbar navbar-expand-lg navbar-light w-100 ${windowSize.innerWidth >= 992 ? " d-none" : " "}`}>
                <div className="container-fluid w-100 mx-0 px-0">
                    <Link className="navbar-brand ps-3 pe-0 mx-0 col-sm-2" to={user.role === "admin" ? "/admin" : "/"}>
                        <img src={logo} alt="logo" className='w-sm-100' />
                    </Link>
                    <div className='d-flex gap-4 justify-content-end align-items-center px-3 col-sm-6'>
                        {
                            user.role === "admin" ? <FontAwesomeIcon className='fs-5' icon={faUser} /> :
                                <span>
                        ...
                        <div className='bg-dark d-flex justify-content-center'>
                            <div className='d-flex flex-column justify-content-start w-100'>
                                <div className=' d-flex align-items-center text-secondary px-3 pt-3'>
                                    {user.role === "admin" ? "You are responsiple for every change" : "Free shipping for standard order over $100"}
                                </div> <hr className='text-muted' />
                                <div className=''>
                                    <ul type="none" className='d-flex mb-3 px-3 align-items-center'>
                    ...
                    <div className='d-flex justify-content-between  w-75'>
                        ...
                        <div className=''>
                            <ul type="none" className='d-flex m-0 p-0'>
                                <li className='py-2 border border-secondary px-3 d-flex align-items-center'><Link className='text-decoration-none text-secondary' to="/admin">Help & FAQs</Link></li>
